...
--
-- 替換檢視表以便查看 `COLLATION_CHARACTER_SET_APPLICABILITY`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_BUFFER_PAGE_LRU`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_BUFFER_POOL_STATS`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_CMP_PER_INDEX`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_CMP_PER_INDEX_RESET`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_FT_BEING_DELETED`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_FT_DEFAULT_STOPWORD`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_FT_INDEX_CACHE`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_FT_INDEX_TABLE`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_SYS_DATAFILES`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_SYS_FOREIGN_COLS`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_SYS_SEMAPHORE_WAITS`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_SYS_TABLESPACES`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_SYS_TABLESTATS`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_TABLESPACES_ENCRYPTION`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `INNODB_TABLESPACES_SCRUBBING`
-- (請參考以下實際畫面)
--
CREATE TABLE `INNODB_TABLESPACES_SCRUBBING` (
`SPACE` bigint(21) unsigned
,`NAME` varchar(655)
,`COMPRESSED` int(1) unsigned
...
,`ON_SSD` int(1) unsigned
);

-- --------------------------------------------------------

--
-- 替換檢視表以便查看 `INNODB_TRX`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `REFERENTIAL_CONSTRAINTS`
-- (請參考以下實際畫面)
--
...
--
-- 檢視表結構 `COLLATION_CHARACTER_SET_APPLICABILITY`
--
...
--
-- 檢視表結構 `INNODB_BUFFER_POOL_STATS`
--
...
--
-- 檢視表結構 `INNODB_CMP_PER_INDEX_RESET`
--
...
--
-- 檢視表結構 `INNODB_FT_DEFAULT_STOPWORD`
--
...
--
-- 檢視表結構 `INNODB_SYS_SEMAPHORE_WAITS`
--
...
--
-- 檢視表結構 `INNODB_TABLESPACES_ENCRYPTION`
--
...
--
-- 檢視表結構 `INNODB_TABLESPACES_SCRUBBING`
--
