...
INSERT INTO `logs` (`id`, `user`, `news`) VALUES
(20, 'admin', 4);
...
(11, '5.以上皆是。', 1, 6),
(12, '問題三：你最常做什麼運動來促進健康體能呢?', 0, 0),
(13, '1.健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 0, 12),
(14, '2.仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 0, 12),
(15, '3.球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 0, 12),
(16, '4.舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 0, 12),
(17, '5.以上皆是。', 0, 12);
