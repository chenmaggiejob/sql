...
--
-- 資料表結構 `events_stages_history_long`
--
...
--
-- 資料表結構 `events_stages_summary_by_account_by_event_name`
--
...
--
-- 資料表結構 `events_stages_summary_by_host_by_event_name`
--
...
--
-- 資料表結構 `events_stages_summary_by_thread_by_event_name`
--
...
--
-- 資料表結構 `events_stages_summary_by_user_by_event_name`
--
...
--
-- 資料表結構 `events_stages_summary_global_by_event_name`
--
...
--
-- 資料表結構 `events_statements_current`
--
...
--
-- 資料表結構 `events_statements_history`
--
...
--
-- 資料表結構 `events_statements_history_long`
--
...
--
-- 資料表結構 `events_statements_summary_by_account_by_event_name`
--
...
--
-- 資料表結構 `events_statements_summary_by_digest`
--
...
--
-- 資料表結構 `events_statements_summary_by_host_by_event_name`
--
...
--
-- 資料表結構 `events_statements_summary_by_thread_by_event_name`
--
...
--
-- 資料表結構 `events_statements_summary_by_user_by_event_name`
--
...
--
-- 資料表結構 `events_statements_summary_global_by_event_name`
--
...
--
-- 資料表結構 `events_waits_history_long`
--
...
--
-- 資料表結構 `events_waits_summary_by_account_by_event_name`
--
...
--
-- 資料表結構 `events_waits_summary_by_host_by_event_name`
--
...
--
-- 資料表結構 `events_waits_summary_by_instance`
--
...
--
-- 資料表結構 `events_waits_summary_by_thread_by_event_name`
--
...
--
-- 資料表結構 `events_waits_summary_by_user_by_event_name`
--
...
--
-- 資料表結構 `events_waits_summary_global_by_event_name`
--
...
--
-- 資料表結構 `file_summary_by_event_name`
--
...
--
-- 資料表結構 `file_summary_by_instance`
--
...
--
-- 資料表結構 `objects_summary_global_by_type`
--
...
--
-- 資料表結構 `session_account_connect_attrs`
--
...
--
-- 資料表結構 `socket_summary_by_event_name`
--
...
--
-- 資料表結構 `socket_summary_by_instance`
--
...
--
-- 資料表結構 `table_io_waits_summary_by_index_usage`
--
...
--
-- 資料表結構 `table_io_waits_summary_by_table`
--
...
--
-- 資料表結構 `table_lock_waits_summary_by_table`
--
