...
('root', '[{\"db\":\"db15\",\"table\":\"title\"},{\"db\":\"school\",\"table\":\"students\"},{\"db\":\"school\",\"table\":\"graduate_school\"},{\"db\":\"school\",\"table\":\"dept\"},{\"db\":\"files\",\"table\":\"images\"},{\"db\":\"school\",\"table\":\"class_student\"},{\"db\":\"school\",\"table\":\"student_scores\"},{\"db\":\"school\",\"table\":\"status\"},{\"db\":\"school\",\"table\":\"classes\"},{\"db\":\"journal\",\"table\":\"records\"}]');
...
('root', 'journal', 'records', '{\"sorted_col\":\"`records`.`id` ASC\"}', '2024-05-16 02:26:42'),
('root', 'school', 'student_scores', '{\"sorted_col\":\"`student_scores`.`school_num` DESC\"}', '2024-05-22 07:28:07'),
('root', 'testschool', 'classrooms', '{\"CREATE_TIME\":\"2024-05-13 09:31:26\",\"col_order\":[0,1,2,3,4],\"col_visib\":[1,1,1,1,1]}', '2024-05-22 01:41:25');
...
('root', '2024-06-13 05:47:47', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"zh_TW\",\"Console\\/Height\":279.996309}');
